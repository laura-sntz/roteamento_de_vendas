...
if __name__ == "__main__":
    try:
        ...
        print("Erro: O arquivo 'matriz_distancias.csv' não foi encontrado.")
        exit()
    ...
    if rota_otima is None:
        ...
        try:
            with open('resultados_branch_and_bound.json', 'w') as f:
                json.dump(resultados, f, indent=4)
            print("Resultados salvos em 'resultados_branch_and_bound.json'.")
